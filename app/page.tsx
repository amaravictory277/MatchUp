        ...
        <div className="relative z-10 flex h-full min-h-0 flex-col px-6 pb-7 pt-6 sm:px-10 sm:pb-9 sm:pt-8 lg:px-16 lg:pt-10">
          <header className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="grid size-9 place-items-center rounded-xl border border-white/15 bg-black/15 text-lg font-black backdrop-blur-sm">M</div>
              <span className="text-xl font-black tracking-[-.04em]">MatchUp</span>
            </div>
            <span className="rounded-full border border-white/15 bg-black/15 px-3 py-1.5 text-[11px] font-bold text-white/90 backdrop-blur-sm">eFootball</span>
          </header>

          <div className="flex min-h-0 flex-1 items-end pb-3 sm:pb-6 lg:pb-8">
            <div className="w-full">
              <p className="mb-3 text-sm font-semibold tracking-tight text-white/95">Welcome to MatchUp ⚽</p>
              ...
              <p className="mt-4 max-w-[480px] text-sm leading-6 text-white/90 sm:text-base">Find your next opponent, join tournaments, and make every match count.</p>
