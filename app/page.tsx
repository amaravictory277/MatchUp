...
export default function Home() {
  return <main className="app-shell"><Navigation />
    ...
    <section className="relative mt-7 overflow-hidden rounded-[28px] border border-[#3c315f] bg-[radial-gradient(circle_at_88%_0%,rgba(123,72,255,.3),transparent_32%),radial-gradient(circle_at_10%_100%,rgba(92,39,207,.18),transparent_38%),linear-gradient(145deg,#171330_0%,#211744_48%,#100f20_100%)] p-4 shadow-[0_18px_55px_rgba(55,25,120,.28)] transition duration-300 hover:-translate-y-0.5 hover:border-[#6149a1] hover:shadow-[0_22px_65px_rgba(76,39,165,.36)] sm:p-5"><div className="pointer-events-none absolute -right-10 -top-10 size-28 rounded-full bg-[#7c4dff]/20 blur-3xl" /><div className="pointer-events-none absolute -bottom-12 left-12 size-24 rounded-full bg-[#4f2aaa]/15 blur-3xl" /><div className="relative z-10 flex flex-col"><div className="inline-flex w-fit items-center gap-2 rounded-full border border-[#5d43a1] bg-[#24184b] px-2.5 py-1 text-[9px] font-black uppercase tracking-[.14em] text-[#c2a8ff]"><Zap size={11} /> Tournament Boost</div><h2 className="mt-3 text-xl font-black tracking-tight text-white sm:text-2xl">Boost Your Tournament &amp; Get Pinned</h2><p className="mt-1 max-w-2xl text-xs leading-5 text-[#d0cbdd] sm:text-sm">Boost your tournament with as little as <strong className="text-white">₦100</strong> and get it pinned to the top for <strong className="text-white">5 hours</strong>.</p><div className="mt-3 flex flex-wrap items-center gap-2 text-[10px] font-semibold text-[#b8b0ca]"><span className="rounded-full border border-white/5 bg-[#17152a]/90 px-3 py-1.5">From ₦100</span><span className="rounded-full border border-white/5 bg-[#17152a]/90 px-3 py-1.5">Pinned for 5 hours</span></div><a href="/tournaments/new" className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl bg-[#6d27ff] px-4 py-3 text-xs font-black text-white shadow-[0_0_28px_rgba(109,39,255,.4)] transition hover:brightness-110 hover:shadow-[0_0_34px_rgba(109,39,255,.55)]">Boost Tournament <ArrowRight size={14} /></a></div></section>
