...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="en"><body>{children}<PresenceProvider/><AuthNotice/><RequestOverlays/><ChatVisualEnhancer/><ServiceWorker/><InstallPrompt/></body></html>; }
