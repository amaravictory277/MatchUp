...
function ChatRoute(){const params=useSearchParams();return <main className="min-h-screen bg-[#061120]"><ChatHub/><ChatDeepLink groupId={params.get("group")||undefined} friendId={params.get("friend")||undefined} createGroup={params.get("create")==="group"}/><MessageInteractionLayer/></main>}
