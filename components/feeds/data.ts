...
export const initialPosts: Post[] = [
  { id: "p1", author: { name: "Daniel Taylor", handle: "@dant", gradient: ["#8e3cff", "#5e1be4"], initials: "DT" }, time: "3 min ago", caption: "Best moment from last night's match! What a game! 🔥⚽", media: ["https://images.pexels.com/photos/27348425/pexels-photo-27348425.jpeg?auto=compress&cs=tinysrgb&w=1000", "https://images.pexels.com/photos/36000773/pexels-photo-36000773.jpeg?auto=compress&cs=tinysrgb&w=1000", "https://images.pexels.com/photos/7005503/pexels-photo-7005503.jpeg?auto=compress&cs=tinysrgb&w=1000"], videoUrl: videoSources.demo, hasVideo: true, likes: 1200, comments: 3, commentList: [{ id: "c1", author: "Amara Okafor", text: "Unreal finish!", time: "2 min ago" }, { id: "c2", author: "Kelvin Mensah", text: "Been watching this on repeat 🔁", time: "1 min ago" }, { id: "c3", author: "Sofia Reyes", text: "Squad looking sharp this season.", time: "just now" }], shares: 70, liked: false, following: false, category: "sports" },
